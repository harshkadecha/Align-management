                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ asset('images/pages/login-v2.svg') }}"
                                    alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                                ...
                                <form class="auth-register-form mt-2" action="{{ route('register') }}"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" id="name"
                                            type="text" name="name" placeholder="Anime"
                                            value="{{ old('name') }}" required autocomplete="name" autofocus
                                            aria-describedby="register-username" tabindex="1" />
                                        @error('name')
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror"
                                            ...
                                            placeholder="anime@world.com" value="{{ old('email') }}" required
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input
                                                ...
                                                required autocomplete="new-password" tabindex="3" /><span
                                    ...
                                    <button class="btn btn-primary w-100" type="submit" tabindex="5">{{ __('Register') }}</button>
                                </form>
                                <p class="text-center mt-2"><span>Already have an account?</span><a
                                        href="{{ route('admin-login') }}"><span>&nbsp;Sign in instead</span></a></p>
