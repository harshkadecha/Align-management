                ...
                <ul class="navbar-nav ms-auto mt-5 mb-3 mb-lg-5 text-end">
                    <li class="nav-item">
                        <a class="nav-link nav-link-option-1 active @if (\Request::route()->getName() == 'home') nav-link-active @endif"
                            aria-current="page" href="{{ route('option1.home') }}"
                            style="color: #FFD700 !important;">HOME</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-option-1 @if (\Request::route()->getName() == 'mission') nav-link-active @endif"
                            aria-current="page" href="{{ route('option1.mission') }}"
                            style="color: #FFD700 !important;">MISSION</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link nav-link-option-1 @if (\Request::route()->getName() == 'services') nav-link-active @endif"
                            href="{{ route('option1.services') }}" style="color: #FFD700 !important;">SERVICES</a>
                    </li>


                    <li class="nav-item ">
                        <a class="nav-link" href="#" style="color: #FFD700 !important;">PAY YOUR BILL</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link @if (\Request::route()->getName() == 'repairs') nav-link-active @endif"
                            href="{{ route('repairs') }}" style="color: #FFD700 !important;">REPAIRS</a>
                    </li>

                    <li class="nav-item ">
                        <a class="nav-link nav-link-option-1 @if (\Request::route()->getName() == 'contact_us') nav-link-active @endif"
                            href="{{ route('option1.contact_us') }}" style="color: #FFD700 !important;">CONTACT US</a>
                    </li>
