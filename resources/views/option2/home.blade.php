                ...
                <ul class="navbar-nav ms-auto mt-5 mb-3 mb-lg-5 text-end">
                    <li class="nav-item">
                        <a class="nav-link nav-link-option-1 active @if (\Request::route()->getName() == 'home') nav-link-active @endif"
                            aria-current="page" href="{{ route('option1.home') }}" style="color: black !important;">HOME</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-option-1 @if (\Request::route()->getName() == 'mission') nav-link-active @endif" aria-current="page"
                            href="{{ route('option1.mission') }}" style="color: black !important;">MISSION</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link nav-link-option-1 @if (\Request::route()->getName() == 'services') nav-link-active @endif"
                            href="{{ route('option1.services') }}" style="color: black !important;">SERVICES</a>
                    </li>
                ...
                <li class="nav-item ">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link nav-link-option-1 @if (\Request::route()->getName() == 'contact_us') nav-link-active @endif"
                            href="{{ route('option1.contact_us') }}" style="color: black !important;">CONTACT US</a>
                    </li>
                    <li class="nav-item">
                        ...
                        data-bs-toggle='dropdown' aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item nav-link nav-link-option-1" href="#" style="color: black !important;">PAY YOUR BILL</a>
                                <a class="dropdown-item nav-link nav-link-option-1" href="{{ route('option1.repairs') }}" style="color: black !important;">REPAIRS</a>
                            </div>
                        </div>
                    </li>
                    {{-- <li class="nav-item">
