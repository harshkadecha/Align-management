<nav class="navbar navbar-expand-lg bg-body-tertiary navbar-custome" style="">
    <div class="container-fluid">
        <a class="navbar-brand ps-4" href="{{ route('home') }}">
            <img src="{{ asset('images/logo/Picture2.png') }}"
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mt-5 mb-3 mb-lg-5 text-end">
                <li class="nav-item">
                    <a class="nav-link active @if (\Request::route()->getName() == 'home') nav-link-active @endif"
                        aria-current="page" href="{{ route('home') }}">HOME</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if (\Request::route()->getName() == 'mission') nav-link-active @endif" aria-current="page"
                        href="{{ route('mission') }}">MISSION</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link @if (\Request::route()->getName() == 'services') nav-link-active @endif"
                ...
                <li class="nav-item ">
                    <a class="nav-link @if (\Request::route()->getName() == 'contact_us') nav-link-active @endif"
